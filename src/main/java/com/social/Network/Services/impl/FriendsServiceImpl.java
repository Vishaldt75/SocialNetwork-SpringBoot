...
import com.social.Network.Entities.Friendship;
import com.social.Network.Entities.User;
import com.social.Network.Repositories.FriendshipRepository;
...
public class FriendsServiceImpl implements FriendsService {
    ...
    public Map<String, Set<UserDTO>> getFriends(Long userId, String search) {
        ...
        Map<Boolean, List<Friendship>> requestMap = requests.stream().collect(Collectors.partitioningBy(Friendship::getAccepted));
